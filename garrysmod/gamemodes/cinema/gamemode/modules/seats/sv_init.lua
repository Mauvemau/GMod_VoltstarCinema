ChairOffsets = {
	...
	["models/props/furnitures/humans/l02_tablebench.mdl"] = {
		{ Pos = Vector(-35, 0, 18), Ang = Angle(0, -90, 0) },
		{ Pos = Vector(-35, 28, 18), Ang = Angle(0, -90, 0) },
		{ Pos = Vector(-35, -28, 18), Ang = Angle(0, -90, 0) },
		{ Pos = Vector(35, 0, 18), Ang = Angle(0, 90, 0) },
		{ Pos = Vector(35, 28, 18), Ang = Angle(0, 90, 0) },
		{ Pos = Vector(35, -28, 18), Ang = Angle(0, 90, 0) },
	},
	["models/props/furnitures/humans/poor_stool_01.mdl"] = {
		{ Pos = Vector(-2, 0, 18), Ang = Angle(0, 0, 0) },
	},
	["models/colourable/paint_couch_01.mdl"] = {
		{ Pos = Vector(10, 18, 32), Ang = Angle(0, -90, 0) },
		{ Pos = Vector(10, -18, 32), Ang = Angle(0, -90, 0) },
	},
	["models/colourable/paint_chair_01.mdl"] = {
		{ Pos = Vector(5, 0, 26), Ang = Angle(0, -90, 0) },
	},
	["models/splayn/rp/lr/couch.mdl"] = {
		{ Pos = Vector(7, 0, 21), Ang = Angle(0, -90, 0) },
		{ Pos = Vector(7, 28, 21), Ang = Angle(0, -90, 0) },
		{ Pos = Vector(7, -28, 21), Ang = Angle(0, -90, 0) } 
	},
	["models/www.gaming-models.de/couch/couch_3er.mdl"] = {
		{ Pos = Vector(17, 0, 21), Ang = Angle(0, -90, 0) },
		{ Pos = Vector(17, 37, 21), Ang = Angle(0, -90, 0) },
		{ Pos = Vector(17, -37, 21), Ang = Angle(0, -90, 0) } 
	},
	["models/www.gaming-models.de/couch/couch_3er.mdl"] = {
		{ Pos = Vector(17, 0, 21), Ang = Angle(0, -90, 0) },
	...
	["models/www.gaming-models.de/couch/couch_2er.mdl"] = {
		{ Pos = Vector(17, 20, 21), Ang = Angle(0, -90, 0) },
		{ Pos = Vector(17, -20, 21), Ang = Angle(0, -90, 0) },
	},
	["models/restaurant_chair.mdl"] = {
		{ Pos = Vector(0, 0, 20), Ang = Angle(0, -90, 0) },
	},
	["models/splayn/rp/lr/chair.mdl"] = {
		{ Pos = Vector(5, 0, 20), Ang = Angle(0, -90, 0) },
	},
	["models/props_altomare/restaurant_stool.mdl"] = {
		{ Pos = Vector(0, 0, 40), Ang = Angle(0, 180, 0) },
	},
	["models/gmod_tower/theater_seat.mdl"] = {
		{ Pos = Vector(1, -5, 23), Ang = Angle(0, 180, 0) }
	},
    ["models/player/shi/magician_seat.mdl"] = {
		{ Pos = Vector(0, -8, 21), Ang = Angle(20, 180, 0) },
		{ Pos = Vector(33, -8, 21), Ang = Angle(20, 180, 0) },
		{ Pos = Vector(-33, -8, 21), Ang = Angle(20, 180, 0) } 
	},
